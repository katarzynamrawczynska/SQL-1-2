...
-- 1. Wyœwietl wszystkie dane faktur z datami najœwie¿szej i najstarszej faktury
SELECT *
FROM tbFaktury
...
-- CTE dla najœwie¿szej i najstarszej daty faktury
WITH FakturyDaty AS (
...
-- 3. Wybierz dane z ograniczeniem sumy ceny sprzeda¿y wiêkszej ni¿ œrednia
SELECT *
FROM LaczoneDane
